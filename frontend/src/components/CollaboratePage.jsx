        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[600px]">
          ...
          <div className="bg-gradient-to-br from-yellow-500/20 to-amber-600/20 p-8 md:p-12 rounded-l-2xl flex flex-col justify-center">
            ...
            <p className="text-gray-300 text-base md:text-lg leading-relaxed">
              Assetmerkle IGDTUW makes it easy and fun to learn by offering insights from experienced students, building connections within a curious community, and keeping the learning experience engaging and stress-free. We're the most active club on campus, buzzing with events and workshops, including a 24-hour hackathon with over 300 participants from across India. Be part of the trend with Assetmerkle!
            </p>
          </div>
          ...
          <div className="p-8 md:p-12 flex flex-col justify-center">
            <form onSubmit={(e) => e.preventDefault()} className="space-y-6">
              ...
              <div className="relative w-full">
                ...
                <textarea
                  placeholder="Please share your expectations for our collaboration"
                  rows="4"
                  className="w-full bg-black/30 border border-white/10 rounded-lg pl-12 pr-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-yellow-400 focus:ring-1 focus:ring-yellow-400 transition-all duration-300"
                ></textarea>
              </div>
